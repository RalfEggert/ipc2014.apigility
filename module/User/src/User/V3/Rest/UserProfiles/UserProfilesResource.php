...
use User\V3\Rest\UserProfiles\Table\UserTable;
use User\V3\Rest\UserProfiles\Table\WebsiteTable;
...
class UserProfilesResource extends AbstractResourceListener
{
    ...
    /**
     * @param \User\V3\Rest\UserProfiles\Table\UserTable $userTable
     */
    ...
    /**
     * @return \User\V3\Rest\UserProfiles\Table\UserTable
     */
    ...
    /**
     * @param \User\V3\Rest\UserProfiles\Table\WebsiteTable $websiteTable
     */
    ...
    /**
     * @return \User\V3\Rest\UserProfiles\Table\WebsiteTable
     */
    ...
    {
        return new ApiProblem(
            405, 'The DELETE method has not been defined for collections'
        );
    }
    ...
    public function fetch($id)
    {
        ...
        if (!$user) {
            return new ApiProblem(
                404, 'User profile for id ' . $id . ' not found'
            );
        }
    ...
    {
        return new ApiProblem(
            405, 'The PUT method has not been defined for collections'
        );
    }
    ...
    {
        return new ApiProblem(
            405, 'The PUT method has not been defined for individual resources'
        );
    }
}